...
if __name__ == '__main__':
    ...
    '''
    model = YOLO(r"runs/LLVIP/LLVIP-yolov5-RGBD-midfusion/weights/best.pt") # select your model.pt path
    ...
    # model = YOLO(r"runs/dota8/dota8-yolo11n-RGBD-midfusion-obb-e300-16-21/weights/best.pt")  # select your model.pt path
    ...
    # # VIDEO
    # model = YOLO(R"runs/M3FD/M3FD-yolov5-RGBD-midfusion/weights/best.pt") # select your model.pt path
    # model.predict(source=r"G:\wan\data\RGBD\testVD\visible\video.mp4",
    #               imgsz=640,
    #               project='runs/detect',
    #               name='exp',
    #               show=False,
